    ...
    <div className="flex h-screen overflow-hidden bg-gray-50">
      ...
      <aside className="flex w-56 flex-col border-r border-gray-200 bg-white">
        ...
        <div className="flex items-center gap-2 border-b border-gray-200 px-4 py-4">
          ...
          <span className="font-semibold text-gray-900">Superleap</span>
        </div>
        ...
        <div className="border-t border-gray-200 p-3">
          <div className="flex items-center gap-2">
            <div className="flex h-7 w-7 items-center justify-center rounded-full bg-blue-600 text-xs font-semibold text-white">RT</div>
            <div className="flex-1 min-w-0">
              <p className="truncate text-xs font-medium text-gray-900">Rahul Thakur</p>
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        <header className="flex h-12 items-center justify-between border-b border-gray-200 bg-white px-4">
          <h1 className="text-sm font-semibold text-gray-900">
            {location.pathname.includes('victory') ? 'Deal Won' :
             location.pathname.includes('conversation') ? 'Live Deal Update' :
             location.pathname.split('/').length > 2 ? 'Deal Room' : 'All Deals'}
          </h1>
